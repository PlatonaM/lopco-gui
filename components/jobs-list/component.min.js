...
class JobsList{constructor(ctr){this.loadStyle();this.container=ctr;this.api='http://localhost:8000/job-manager/'}
...
draw(){super.draw('history','history',true);}}