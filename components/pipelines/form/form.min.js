...
c_num++;}}
const st_id=this.genRandomID();this.stage_container.append(document.createRange().createContextualFragment(Mustache.render(Form.stage_template,{id:st_id,number:st_num,description:(data)?data['description']:null,w_name:this.workers[wk_id]['name'],w_id:wk_id,input:inputs,output:(this.workers[wk_id]['output'])?this.workers[wk_id]['output']['fields']:null,has_configs:!!(this.workers[wk_id]['configs']),configs:configs,i_type:this.workers[wk_id]['input']['type'],o_type:(this.workers[wk_id]['output'])?this.workers[wk_id]['output']['type']:'null'})));this.stages[st_num]={id:st_id,wk_id:wk_id};}
